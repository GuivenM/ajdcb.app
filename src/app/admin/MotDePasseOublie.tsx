    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
          ...
          {message ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p className="text-sm text-slate-500 mb-5">
                Indiquez l'email de votre compte admin : si un accès existe, vous recevrez un lien pour choisir un nouveau mot de passe.
              </p>
        ...
        <p className="text-center mt-6">
          <Link to="/admin/login" className="text-slate-400 text-sm hover:text-white inline-flex items-center gap-1">
